...
import { fixedLikesService } from '@/services/fixedLikesService';
...
export const useFixedLikes = () => {
  ...
  const likeMutation = useMutation({
    mutationFn: async (postId: string) => {
      ...
      return await fixedLikesService.toggleLike(postId);
    },
